        ...
        <section className="relative min-h-screen overflow-hidden">
            ...
            <div className="relative z-10 flex justify-center items-center h-full min-h-screen px-8 text-center">
                <div className="text-center">
                    <h1 className='text-[64px] text-[#D2D3D4] font-[400] leading-[87px] max-w-[546px] w-full mx-auto text-center mb-[24px]'>
                        WELCOME TO
                        <span className='mx-auto text-center'>
                            <img src={LogoBigger} alt="logoBig" className='max-w-[326px] w-full mx-auto cursor-pointer' />
                        </span>
                    </h1>

                    <h3 className='capitalize text-[36px] font-[400] leading-normal text-[#D2D3D4]'>
                        Where <span className='text-[#FFCC2A]'> Adrenaline</span>  and <span className='text-[#FFCC2A]'>Asphalt</span> Meet
                    </h3>
                    <p className='inter italic text-[20px] font-[400] leading-normal text-center text-[#D2D3D4]'>
                    ...
                    <div className='max-[500px] w-full flex flex-row justify-center items-center gap-2 mt-[40px]'>
