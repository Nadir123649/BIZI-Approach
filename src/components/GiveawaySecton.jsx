...
const GiveawaySecton = ({ title }) => {
    return (
        <section className='bg-[#0D1B21] pt-[30px] md:pt-[40px] pb-[20px] md:pb-[60px] relative min-h-auto overflow-hidden ' >
            <img src={LeftUnion} alt="left-line" className='w-full absolute top-[60px]' />
            <div className='px-[2px] md:px-[40px]'>
                <div className='flex items-center justify-end gap-[30px] mt-[20px] md:mt-[40px] mr-[14px]  md:mr-[32px]'>
